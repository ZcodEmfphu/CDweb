...
<body onload="disableSubmitBtn()">
    ...
    <form name="updateAccount" action="validate" method="post">
        ...
        <table border="0" cellpadding="5" cellspacing="0">
            <tr>
                <td><b>User Id:</b></td>
                <td><input type="text" size="20" id="userid" name="id" onkeyup="validateUserId()"></td>
                <td>
                    <div id="userIdMessage"></div>
                </td>
            </tr>
            <tr>
                <td align="right" colspan="2"><input id="submit_btn" type="Submit" value="Create Account"></td>
                <td></td>
            </tr>
        </table>
    </form>

    <script src="./scripts/jquery-fetch-promise.js"></script>
</body>
</html>
